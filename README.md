...
Po sklonowaniu kodu repozytorium i upewnieniu się, że posiadamy zainstalowane środowisko Node.js oraz menager pakietów npm. Pobieramy potrzebne biblioteki do uruchomienia aplikacji:
